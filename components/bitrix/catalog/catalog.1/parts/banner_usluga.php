...
<div class="my-flex-cont-img">
    <div class="my-flex-box-img">
        ...
        <ul>
            ...
            <li>
                <p>Стоимость диагностики <?= $arSection["UF_INSTR"] ?> 1000 р. в случае отказа от ремонта</p>
            </li>
            <li>
                <p>Срок ремонта <?= $arSection["UF_INSTR"] ?> зависит от наличия запчастей, и начинается на этапе диагностики.</p>
            </li>
        </ul>
    </div>
    <div class="my-flex-box-img">
